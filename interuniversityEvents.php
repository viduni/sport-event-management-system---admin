...
<!-- Form -->
<div class="container">
	<h2>Inter University Events<h2>
	<form class="form-horizontal" action="interunievent.php" method="POST">
	...
	<div class="col-sm-8">
		<input type="time" class="form-control"  name="timeOF" required>
	</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">        
      <div class="col-sm-offset-4 col-sm-10">
		...
		<button type="submit" class="btn  button" name="view"><a href="interunievent_view.php" id="a1">View</a></button>
      </div>
    </div>
	</form>
