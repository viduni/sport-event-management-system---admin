...
<div class="container">
	<h2>Book Gym<h2>
	<form class="form-horizontal" action="inadmin_gym.php" method="POST">
	...
	<div class="form-group">        
      <div class="col-sm-offset-4 col-sm-10">
		...
		<button type="submit" class="btn  button" name="view_book"><a href="adbookgym_view.php" id="a1">View Booking</a></button>
		<button type="submit" class="btn  button" name="view_req"><a href="usbookgym_view.php" id="a1">View Request</a></button>
