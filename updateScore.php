...
<div class="container">
	<h2>Update Scores<h2>
	<form class="form-horizontal" action="inUpdatescore.php" method="POST">
	...
	<div class="form-group">        
      <div class="col-sm-offset-4 col-sm-10">
		...
		<button type="submit" class="btn  button" name="view"><a href="updateScore_view.php" id="a1">View</a></button>
      </div>
    </div>
	</form>
