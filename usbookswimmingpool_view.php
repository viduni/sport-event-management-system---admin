...
<div class="content">
<div class="container">
  <h1>User Requests for Swimming Pool</h1><br>
   <button type="submit" class="btn  button" name="submit"><a href="adbook_swimmingpool.php" id="a1">Back to Form</a></button>
   <br><br>
  <table class="table table-bordered">
	...
	<?php
	include 'dbh.php';
	$sql="SELECT * from user_swimmingpool ORDER BY ID DESC";
	$view = $conn->query($sql);
