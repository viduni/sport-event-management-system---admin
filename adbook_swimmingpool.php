...
<div class="container">
	...
	<form class="form-horizontal" action="inadmin_swimmingpool.php" method="POST">
	...
	<div class="form-group">        
      <div class="col-sm-offset-4 col-sm-10">
		...
		<button type="submit" class="btn  button" name="view_book"><a href="adbookswimmingpool_view.php" id="a1">View Booking</a></button>
		<button type="submit" class="btn  button" name="view_req"><a href="usbookswimmingpool_view.php" id="a1">View Request</a></button>
